...
- 設定
  - SF設定を減らし、物語の問題を派生した現象で解決する。具体的には、ウィーブ、プロテクトなど。
  - ウィーブの代わりにミラーニューロンの副作用にする。
  - 各登場人物の短期・長期の行動原理を設定し、主人公と関係性の変化に必然性を与える。イーライのせせこましさ、アリスのシンプルさは残す、ボブの薄っぺらさは残す方向で。
  - 男性を減らし、ジェンダーバランスの悪さに注目させない。
  - テーマを設定し、物語の軸にすえる。組織論、リーダーシップ論。バックオフィスで解決。
- 構成
  - 主人公自身や関係性（＝会社での立場）の変化の過程を含める。
  - いつ、どこで、何が起こっているのかを分かりやすくする。e.g. 時系列のいったりきたりを減らす。章に名前をつける。倒叙にする。
  - 「宇宙に行く」必然性を作るか、何言ってんのか分からない系にする。
  - シーケンスを作用・反作用を連鎖させる
- 表現
  - トピックの凝集度を高める
