...
- 設定
  - 「プロテクト」の役割を、新たな設定以外で解決させ、世界設定をシンプルにする
  - 各登場人物の短期・長期の行動原理を設定し、主人公と関係性の変化に必然性を与える
  - 男性を減らし、ジェンダーバイアスを取り除く
  - テーマを設定し、物語の軸にすえる
- 構成
  - 時間のいったりきたりを減らし、いつ、どこで、何が起こっているのかを分かりやすくする
  - 「宇宙に行こく」必然性を作る
  - シーケンスレベルで作用・反作用を連鎖させる
- 表現
  - トピックの凝集度を高める
  - 語りのパターンを一貫させ、読みやすくする
